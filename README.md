...
| **Current release** | [v0.6.1](https://github.com/ferdinandobons/brand-docs/releases/tag/v0.6.1) alpha |
...
Latest release: [v0.6.1](https://github.com/ferdinandobons/brand-docs/releases/tag/v0.6.1). See [CHANGELOG.md](CHANGELOG.md).
